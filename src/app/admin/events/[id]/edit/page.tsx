/**
 * /admin/events/[id]/edit — edição de evento com FormBuilder e gestão de TicketTypes.
 * Pré-popula o formulário com os dados atuais do banco.
 *
 * Regra de ingressos: totalQuantity nunca pode ser menor que soldQuantity
 * (validada no client via AdminEventForm e no servidor via PATCH /api/admin/events/[id]).
 */
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return { title: event ? `Admin — Editar: ${event.title}` : "Admin — Editar Evento" };
}
